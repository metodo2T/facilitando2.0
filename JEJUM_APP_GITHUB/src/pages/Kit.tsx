              ...
              <div key={idx} className="bg-brand-card p-5 rounded-[24px] border border-white/5 shadow-lg shadow-black/20">
                ...
                <div className="space-y-1.5 pl-1">
                  {category.items.map((item, i) => {
                    ...
                    return (
                      <label key={i} onClick={() => toggleItem(item)} className="flex items-center gap-3.5 p-2 rounded-xl hover:bg-brand-dark/50 transition-colors cursor-pointer group active:scale-[0.99]">
